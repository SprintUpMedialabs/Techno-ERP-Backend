...
courseMetaDataRoute.get('/:courseCode', jwtAuthenticationMiddleware_1.authenticate, (0, jwtAuthenticationMiddleware_1.authorize)([constants_1.UserRoles.BASIC_USER]), courseMetadataController_1.getCourseMetadataBy);
