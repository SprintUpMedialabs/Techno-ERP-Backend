...
const safeAxiosPost = (axiosClient, url, data, config) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        logger_1.default.error(`Audit log service failed for POST ${url}:`, (_b = (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data) !== null && _b !== void 0 ? _b : error.message);
    }
});
