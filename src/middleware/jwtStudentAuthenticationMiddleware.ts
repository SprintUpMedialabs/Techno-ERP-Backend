...
export const authenticate = expressAsyncHandler(async (req: AuthenticatedRequest, _: Response, next: NextFunction) => {
    ...
    const decoded = studentJwtHelper.verifyToken(token);
