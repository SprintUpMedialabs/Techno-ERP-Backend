...
// export const createStudentToken = (payload: object, options: SignOptions): string => {
//   return jwt.sign(payload, STUDENT_JWT_SECRET, options);
// };

// export const verifyStudentToken = (token: string): object | null => {
//   try {
//     return jwt.verify(token, STUDENT_JWT_SECRET) as object;
//   } catch (error: any) {
//     throw createHttpError(400, 'Invalid token');
//   }
// };

// export const decodeStudentToken = (token: string): object | null => {
//   try {
//     return jwt.decode(token) as object;
//   } catch (error: any) {
//     throw createHttpError(500, 'Invalid Token.');
